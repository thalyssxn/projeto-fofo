document.addEventListener('DOMContentLoaded', function() {
    // =========================================================
    // 1. DATA DE INÍCIO DO RELACIONAMENTO (CORRIGIDA PARA 8 DE FEVEREIRO DE 2024, 22:00:00)
    // Mês 1 = Fevereiro
    // =========================================================
    ...
    const boasVindasOverlay = document.getElementById('boasVindasOverlay');
    const btnIniciarPresente = document.getElementById('iniciarPresente'); 
